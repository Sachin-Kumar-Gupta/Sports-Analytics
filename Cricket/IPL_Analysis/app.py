...
def load_team_batting_stats():
    return pd.read_csv('season_team_batting_phase.csv')

@st.cache_data
def load_team_bowling_stats():
    return pd.read_csv('season_team_bowling_phase.csv')
...
def load_player_batting():
    return pd.read_csv('player_batting_20_25.csv')

@st.cache_data
def load_player_bowling():
    return pd.read_csv('player_bowling_20_25.csv')

@st.cache_data
def load_batting_stats():
    return pd.read_csv('season_phase_batting_df.csv')

@st.cache_data
def load_bowling_stats():
    return pd.read_csv('season_phase_bowling_df.csv')
...
if analysis_type == 'Select':
    ...
    <div style='text-align:center; margin-top:40px;'>
        <img src="data:image/png;base64,{img_base64}" width="90" style="margin-bottom:10px;">
